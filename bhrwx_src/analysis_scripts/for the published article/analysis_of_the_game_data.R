...
data <- read.xlsx("anonymized_game_data.xlsx") #update the file direction when doing your analysis based on where the data file is in relation to the location of this script
...
# save the age graph 
ggsave("experiential_learning/graphs/age_distribution.pdf", width = 6, height = 4.5, dpi = 1000)
...
anger_1
effectsize::cohens_d(data$anger ~ 1, mu = 1) # effect size 
d.ci(0.7703066, n1=14064) # something wrong with CI s o we calculate with this function instead
